...
def load_data(data_dir):
    ...
    images = []
    labels = []
    for sub_class in os.listdir(data_dir):
        # Path for each class in categories
        sub_data_dir = os.path.join(data_dir, sub_class)
        for file in os.listdir(sub_data_dir):
            # Path for an image in the class
            file_dir = os.path.join(sub_data_dir, file)
